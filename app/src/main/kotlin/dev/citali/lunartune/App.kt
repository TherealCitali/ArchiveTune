...
import dev.citali.lunartune.innertube.models.YouTubeLocale
import dev.citali.lunartune.kugou.KuGou
import dev.citali.lunartune.lastfm.LastFM
import dev.citali.lunartune.morideobfuscator.MoriCipherConfig
...
import dev.citali.lunartune.utils.clearPlaybackAuthSession
import dev.citali.lunartune.utils.clearPlaybackWebAuthSession
...
class App :
    ...
    private fun initializeCriticalSync() {
        ...
        LunarTuneCanvas.initialize(BuildConfig.CANVAS_BEARER_TOKEN)
        PaxsenixLyrics.setUserAgent("LunarTune", BuildConfig.VERSION_NAME)
