...
import dev.citali.lunartune.logcat.LogcatLevel
import dev.citali.lunartune.ui.utils.backToMain
import dev.citali.lunartune.viewmodels.LogcatEffect
import dev.citali.lunartune.viewmodels.LogcatScreenState
import dev.citali.lunartune.viewmodels.LogcatUiEntries
import dev.citali.lunartune.viewmodels.LogcatUiEntry
import dev.citali.lunartune.viewmodels.LogcatUiModel
import dev.citali.lunartune.viewmodels.LogcatViewModel
import dev.citali.lunartune.ui.component.IconButton as LunarTuneIconButton
            ...
            when (effect) {
                ...
                is LogcatEffect.Export -> {
                    val exportIntent =
                        Intent(Intent.ACTION_SEND).apply {
                            type = "text/plain"
                            clipData = ClipData.newRawUri("lunartune-log.txt", effect.uri)
