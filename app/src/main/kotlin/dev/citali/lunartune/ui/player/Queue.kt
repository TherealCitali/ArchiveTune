...
import dev.citali.lunartune.ui.component.MediaMetadataListItem
import dev.citali.lunartune.ui.component.TextFieldDialog
import dev.citali.lunartune.ui.menu.AddToPlaylistDialog
                                                    ...
                                                    onClick = {
                                                        if (selection) {
                                                            ...
                                                            if (index == currentWindowIndex) {
                                                                ...
                                                                val joined =
                                                                    togetherSessionState as? dev.citali.lunartune.together.TogetherSessionState.Joined
                                                                val isGuest = joined?.role is dev.citali.lunartune.together.TogetherRole.Guest
                                                                if (isGuest) {
