...
class BackgroundMusicRecognitionService : Service() {
    ...
    companion object {
        private const val ActionRecognizePlayback =
            "dev.citali.lunartune.action.RECOGNIZE_DEVICE_PLAYBACK"
        private const val ActionRecognizeMicrophone =
            "dev.citali.lunartune.action.RECOGNIZE_MICROPHONE"
        private const val ActionCancel =
            "dev.citali.lunartune.action.CANCEL_BACKGROUND_RECOGNITION"
