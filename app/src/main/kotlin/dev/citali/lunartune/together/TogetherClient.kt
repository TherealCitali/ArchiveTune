...
sealed interface TogetherClientEvent {
    ...
    data class JoinDecision(
        val decision: dev.citali.lunartune.together.JoinDecision,
    ) : TogetherClientEvent

    data class HostTransferred(
        val transfer: dev.citali.lunartune.together.HostTransferred,
    ) : TogetherClientEvent
    ...
    data class HeartbeatPong(
        val pong: dev.citali.lunartune.together.HeartbeatPong,
                ...
                try {
                    while (true) {
                        ...
                        when (message) {
                            ...
                            is dev.citali.lunartune.together.JoinDecision -> {
                            ...
                            is dev.citali.lunartune.together.HostTransferred -> {
                                if (message.sessionId == sessionId) {
