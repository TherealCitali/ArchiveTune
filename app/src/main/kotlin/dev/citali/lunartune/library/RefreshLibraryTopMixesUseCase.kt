...
import dev.citali.lunartune.ai.AiTextService
        ...
        private suspend fun requestAiMixes(
            ...
            val response =
                AiTextService.complete(
                    ...
                    systemPrompt =
                        """
                        You are a music curator for LunarTune.
...
private fun List<dev.citali.lunartune.innertube.models.Artist>.matchesAnyLocalArtist(song: Song): Boolean {
