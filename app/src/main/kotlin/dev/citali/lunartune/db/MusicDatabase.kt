...
package dev.citali.lunartune.db
...
import dev.citali.lunartune.db.entities.AlbumArtistMap
...
import dev.citali.lunartune.db.entities.LibraryTopMixSongMap
import dev.citali.lunartune.db.entities.LyricsEntity
import dev.citali.lunartune.db.entities.PlayCountEntity
import dev.citali.lunartune.db.entities.PlaylistEntity
import dev.citali.lunartune.db.entities.PlaylistSongMap
import dev.citali.lunartune.db.entities.PlaylistSongMapPreview
import dev.citali.lunartune.db.entities.PlaylistTagMap
import dev.citali.lunartune.db.entities.RelatedSongMap
import dev.citali.lunartune.db.entities.SearchHistory
import dev.citali.lunartune.db.entities.SetVideoIdEntity
import dev.citali.lunartune.db.entities.SongAlbumMap
import dev.citali.lunartune.db.entities.SongArtistMap
import dev.citali.lunartune.db.entities.SongEntity
import dev.citali.lunartune.db.entities.SortedSongAlbumMap
import dev.citali.lunartune.db.entities.SortedSongArtistMap
...
private class DatabaseCallback : RoomDatabase.Callback() {
    override fun onOpen(db: SupportSQLiteDatabase) {
        super.onOpen(db)
        // shutdown() right after execute(): the executor still runs the queued task, but its
        // worker thread exits when done instead of parking forever. Without it every
        // onOpen (each Room connection open, plus every restore/import that reopens the DB)
        // leaked one idle thread for the life of the process.
