...
import dev.citali.lunartune.constants.GitHubContributorsEtagKey
import dev.citali.lunartune.constants.GitHubContributorsJsonKey
import dev.citali.lunartune.constants.GitHubContributorsLastCheckedAtKey
import dev.citali.lunartune.constants.GitHubTranslationContributorsJsonKey
import dev.citali.lunartune.constants.GitHubTranslationContributorsLastCheckedAtKey
import dev.citali.lunartune.constants.StorageFolderDisplayNameKey
import dev.citali.lunartune.constants.StorageFolderIdKey
import dev.citali.lunartune.constants.StorageFolderPathKey
import dev.citali.lunartune.constants.StorageFolderTreeUriKey
...
import dev.citali.lunartune.utils.ArtworkStorage
...
private fun File.ensureWritableDirectory(): Boolean =
    runCatching {
        ...
        val probe = File(this, ".lunartune-storage-probe")
        probe.writeText("ok")
        probe.delete()
    }.isSuccess
...
private const val ExternalStorageRootDirectoryName = "LunarTune"
...
private const val SavedArtworkCacheFileName = "lunartune_saved_artworks.json"
