...
package dev.citali.lunartune.ai
            ...
            for (index in 0 until elements.length) {
                ...
                val lineKey =
                    readAttributeBySuffix(element, "key")
                        ?: "lunartune-translation-$segmentId".also { key -> element.setAttribute("key", key) }
...
private data class TtmlLyricsDocument(
    ...
    override fun rebuild(translations: Map<Int, String>): String {
        removeLunarTuneTranslationElements(document.documentElement)
        ...
        if (translatedParagraphs.isNotEmpty()) {
            ...
            val translationElement =
                document.createElement("translation").apply {
                    setAttribute("data-lunartune", "translation")
                }
    ...
    private fun removeLunarTuneTranslationElements(root: Element) {
        ...
        for (index in 0 until elements.length) {
            ...
            if (element.tagName.endsWith("translation", ignoreCase = true) &&
                element.getAttribute("data-lunartune") == "translation"
            ) {
