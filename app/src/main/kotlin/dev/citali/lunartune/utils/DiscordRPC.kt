...
import dev.citali.lunartune.constants.DiscordActivityButton1CustomUrlKey
import dev.citali.lunartune.constants.DiscordActivityButton1EnabledKey
import dev.citali.lunartune.constants.DiscordActivityButton1LabelKey
import dev.citali.lunartune.constants.DiscordActivityButton1UrlSourceKey
import dev.citali.lunartune.constants.DiscordActivityButton2CustomUrlKey
import dev.citali.lunartune.constants.DiscordActivityButton2EnabledKey
import dev.citali.lunartune.constants.DiscordActivityButton2LabelKey
import dev.citali.lunartune.constants.DiscordActivityButton2UrlSourceKey
import dev.citali.lunartune.constants.DiscordActivityDetailsKey
import dev.citali.lunartune.constants.DiscordActivityNameKey
import dev.citali.lunartune.constants.DiscordActivityPlatformKey
import dev.citali.lunartune.constants.DiscordActivityStateKey
import dev.citali.lunartune.constants.DiscordActivityTypeKey
import dev.citali.lunartune.constants.DiscordLargeImageCustomUrlKey
import dev.citali.lunartune.constants.DiscordLargeImageTypeKey
import dev.citali.lunartune.constants.DiscordLargeTextCustomKey
import dev.citali.lunartune.constants.DiscordLargeTextSourceKey
import dev.citali.lunartune.constants.DiscordPresenceStatusKey
import dev.citali.lunartune.constants.DiscordSmallImageCustomUrlKey
import dev.citali.lunartune.constants.DiscordSmallImageTypeKey
import dev.citali.lunartune.constants.EnableTranslatorKey
import dev.citali.lunartune.constants.TranslatorContextsKey
import dev.citali.lunartune.constants.TranslatorTargetLangKey
import dev.citali.lunartune.db.entities.Song
import dev.citali.lunartune.discord.DiscordActivityPlatform
import dev.citali.lunartune.discord.DiscordActivityType
import dev.citali.lunartune.discord.DiscordOnlineStatus
import dev.citali.lunartune.discord.DiscordPresenceActivity
import dev.citali.lunartune.discord.DiscordPresenceAssets
import dev.citali.lunartune.discord.DiscordPresenceButton
import dev.citali.lunartune.discord.DiscordPresenceTimestamps
import dev.citali.lunartune.discord.DiscordSocialPresenceClient
import dev.citali.lunartune.discord.DiscordStatusDisplayType
...
class DiscordRPC(
    ...
    private suspend fun resolveButtons(song: Song): List<DiscordPresenceButton> {
        ...
        val button2Label = context.dataStore[DiscordActivityButton2LabelKey] ?: "Go to LunarTune"
