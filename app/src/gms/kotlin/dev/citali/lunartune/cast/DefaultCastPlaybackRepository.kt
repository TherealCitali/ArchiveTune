...
private class GmsCastMediaItemConverter(
    ...
    private fun MediaInfo?.toAppMediaMetadata(mediaId: String): dev.citali.lunartune.models.MediaMetadata {
        val castMetadata = this?.metadata
        val title = castMetadata?.stringValue(CastMetadata.KEY_TITLE) ?: mediaId
        val artistText =
        ...
        return dev.citali.lunartune.models.MediaMetadata(
            ...
            album =
                albumTitle?.let {
                    dev.citali.lunartune.models.MediaMetadata.Album(
                        id = it,
                        title = it,
                    )
                },
    ...
    private fun openResolvedRemoteSource(
        ...
        val connection =
            (URL(resolvedUri.toString()).openConnection() as HttpURLConnection).apply {
                ...
                setRequestProperty("User-Agent", "LunarTune Cast")
