...
package dev.citali.lunartune.ads.data
...
import dev.citali.lunartune.ads.domain.SupportPageRepository
...
internal class BrowserSupportPageRepository
    ...
    constructor(
        ...
        private fun supportPageUnavailable(exception: RuntimeException): SupportPageOpenResult {
            Timber.w(exception, "Unable to open the LunarTune support page")
            return SupportPageOpenResult.Unavailable
        }

        private companion object {
            val SUPPORT_PAGE_URI: Uri = Uri.parse("https://lunartune.koiiverse.cloud/support")
        }
    }
