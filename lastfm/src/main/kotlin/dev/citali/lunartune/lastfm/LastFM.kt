...
package dev.citali.lunartune.lastfm
...
import dev.citali.lunartune.lastfm.models.LastFmError
import dev.citali.lunartune.lastfm.models.TokenResponse
import java.net.URI
...
object LastFM {
    ...
    const val FALLBACK_COMPAT_API_KEY = "lunartune"
    const val FALLBACK_COMPAT_SECRET = "lunartune"
    ...
    private fun HttpRequestBuilder.lastfmParams(
        ...
        headers.append(HttpHeaders.UserAgent, "LunarTune (https://github.com/rukamori/ArchiveTune)")
        val paramsForSig =
            mutableMapOf(
                "method" to method,
                "api_key" to apiKey,
